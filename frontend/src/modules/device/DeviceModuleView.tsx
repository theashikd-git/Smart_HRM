...
/**
 * Root view for the top-level "Device" module (see TopNavigation's MODULES
 * list). Ported from the old app/device/page.tsx, which used the dead
 * components/layout/AppShell and was never reachable from the live
 * Workbench shell -- the module button just sat disabled with a "Soon"
 * badge while this whole screen (and the backend device/ZKTeco service
 * behind it) already existed. Same single-screen shape as Leave/System
 * Settings: its own header here, no sidebar or Workbench tabs.
 */
export function DeviceModuleView() {
  ...
  return (
    <div className="h-full overflow-auto bg-surface p-4">
      <div className="mb-4 flex items-center justify-between">
        <div>
          <h1 className="text-[15px] font-semibold text-text-primary">Device Management</h1>
          <p className="text-xs text-text-secondary">Control your ZKTeco uFace 800 Plus and employee synchronization</p>
        </div>
